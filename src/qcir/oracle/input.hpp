...
Abc_Ntk_t* abc_rewrite(Abc_Ntk_t* pNtk, bool use_zeros = false);
Abc_Ntk_t* abc_refactor(Abc_Ntk_t* pNtk, bool use_zeros = false);
Abc_Ntk_t* abc_resub(Abc_Ntk_t* pNtk, bool use_zeros = false, int n_cuts_max = 8);
