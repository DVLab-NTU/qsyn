...
font = \sffamily,
    ...
    \node[zspi,label={ [label distance=-2]90:{\color{phaseColor}\tiny $\frac{\pi}{ \mathsf{4}}$ }}](7)  at (6.000000,1) {{\tiny 7}};
    \node[zspi,label={ [label distance=-2]90:{\color{phaseColor}\tiny $\frac{\mathsf{7}\pi}{ \mathsf{4}}$ }}](10)  at (6.000000,2) {{\tiny 10}};
    \node[zspi,label={ [label distance=-2]90:{\color{phaseColor}\tiny $\frac{\mathsf{7}\pi}{ \mathsf{4}}$ }}](12)  at (6.000000,0) {{\tiny 12}};
