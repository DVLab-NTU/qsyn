...
cx q[2], q[0];
ry(-0.02721710272734028) q[0];
cx q[2], q[0];
ry(0.02721710272734028) q[0];
rz(0.7479982508547125) q[0];
cx q[1], q[2];
rz(2.3935944027350806) q[0];
cx q[2], q[0];
ry(-0.02721710272734028) q[0];
cx q[2], q[0];
ry(0.02721710272734028) q[0];
...
cx q[2], q[0];
ry(-0.027217102727348442) q[0];
cx q[2], q[0];
ry(0.027217102727348442) q[0];
rz(-2.8423933532479086) q[0];
cx q[1], q[2];
rz(-0.2991993003418847) q[0];
cx q[2], q[0];
ry(-0.027217102727348442) q[0];
cx q[2], q[0];
ry(0.027217102727348442) q[0];
