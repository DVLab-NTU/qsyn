...
ZXGraph *HGate::getZXform(size_t &baseId, bool silent)
{
    ...
    temp->addEdgeById(baseId - 1, baseId + 1, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 1, baseId - 2, EdgeType::SIMPLE, silent);
    baseId++;
    return temp;
}
...
ZXGraph *CXGate::getZXform(size_t &baseId, bool silent)
{
    ...
    temp->addEdgeById(baseId - 1, baseId + 1, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 1, baseId - 3, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId - 2, baseId + 2, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 2, baseId - 4, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 1, baseId + 2, EdgeType::SIMPLE, silent);
    baseId += 2;
    return temp;
}
...
ZXGraph *CZGate::getZXform(size_t &baseId, bool silent)
{
    ...
    temp->addEdgeById(baseId - 2, baseId + 2, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 2, baseId - 4, EdgeType::SIMPLE, silent);
    temp->addEdgeById(baseId + 1, baseId + 2, EdgeType::HADAMARD, silent);
    baseId += 2;
    return temp;
}
