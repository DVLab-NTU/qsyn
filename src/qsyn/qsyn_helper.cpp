...
bool initialize_qsyn(
    ...
    qsyn::experimental::NcfMgr& ncf_mgr) {
    ...
    return dvlab::add_cli_common_cmds(cli) &&
           ...
           qsyn::experimental::add_tableau_command(cli, tableau_mgr, ncf_mgr) &&
           qsyn::experimental::add_ncf_command(cli, ncf_mgr, tableau_mgr, qcir_mgr);
}
