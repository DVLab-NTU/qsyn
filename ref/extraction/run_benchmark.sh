...
##NOTE - Other 1
for file in urf2_277 life_238 9symml_195 dist_223; do
    ../../qsyn -f "dof/${file}.dof" > ref/${FOLDER}/${file}-O3.log 2>&1
done
##NOTE - Other 2
...
##NOTE - Big cases
for file in urf1_278 urf1_149; do
    ../../qsyn -f "dof/${file}.dof" > ref/${FOLDER}/${file}-O3.log 2>&1
done
##NOTE - Wrong Full Reduced
for file in hwb8_113; do
    ../../qsyn -f "dof/${file}.dof" > ref/${FOLDER}/${file}-O3.log 2>&1
done
